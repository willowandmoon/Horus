        ...
        <div className="min-h-screen bg-[#EDF2F4] flex flex-col">
            <header className="flex items-center justify-between px-6 md:px-10 py-6 bg-white border-b border-[#EDF2F4]">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-xs text-[#8D99AE] uppercase tracking-[0.2em]">Pago aprobado</p>
            ...
            <main className="flex-1 px-6 md:px-10 py-10">
                <div className="max-w-3xl mx-auto">
                    <div className="bg-white border border-[#EDF2F4] rounded-2xl p-8 shadow-sm text-center">
                        <div className="w-16 h-16 rounded-full bg-[#DCFCE7] text-[#22C55E] flex items-center justify-center mx-auto">
                            <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                            </svg>
                        </div>
                        <h2 className="text-2xl font-bold text-[#2B2D42] mt-4">Pago aprobado</h2>
                        <p className="text-sm text-[#8D99AE] mt-2">
                            Tu pago fue confirmado por Mercado Pago. Hemos activado tu suscripcion.
                        </p>
                        ...
                        <div className="mt-6 text-left border-t border-[#EDF2F4] pt-6 space-y-2 text-sm text-[#8D99AE]">
                            ...
                            <div className="flex items-center justify-between">
                                <span>Estado</span>
                                <span className="text-[#22C55E] font-semibold">{order?.status ?? "PAID"}</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span>Total</span>
